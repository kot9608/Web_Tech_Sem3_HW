...
// Где вместо 21 и 69.8 
// должны быть подставлены соответствующие значения, 
// которыебыли получены ранее.
...
const num1 = Number.parseFloat(prompt("Введите температуру по Цельсию: ")); 
...
alert(`Значение темпретуры ${num1} по Цельсию = ${fareng(num1).toFixed(2)} по Фаренгейту `);